...
В этом проекте представлена реализация класса Weapon на языке Python, который моделирует игровое оружие. Класс хранит информацию о нsазвании, базовом уроне, редкости, уровне и состоянии целостности (сломано / не сломано), а также предоставляет методы для изменения этих данных с обязательной валидацией.
